...
- **Fuzzy Search:** Type to search across all pages by title, path, and description
- **Recent Pages:** Recently visited pages appear for quick access
- **Pinned Pages:** Bookmark frequently used pages with Space
...
<CardGrid>
  ...
  <LinkCard title="Fuzzy Search" href="/guides/fuzzy-search/" description="Configure search behavior" />
